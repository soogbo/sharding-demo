 ...
 * 用户表分表配置
 */
public class UserTableRuleConfig extends TableRuleConfiguration {
    /**
     * 主键生成成器
     */
//    private KeyGenerator keyGenerator;

    public UserTableRuleConfig(String logicDataSource, KeyGenerator keyGenerator, String inline) {
