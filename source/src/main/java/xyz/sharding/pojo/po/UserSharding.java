 ...
 */
@Entity
@Table(name = UserSharding.TABLE_NAME)
public class UserSharding implements Serializable {
    
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "u_user_sharding";

    public static final String GENERATE_COLUMN = "id";
    public static final String SHARDING_COLUMN = "user_id";
